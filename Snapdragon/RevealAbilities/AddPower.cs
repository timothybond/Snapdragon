...
{
    public record AddPower(ICardFilter<Card> Filter, IPowerCalculation<Card> Power) : IRevealAbility<Card>
    {
        public AddPower(ICardFilter<Card> Filter, int Power) : this(Filter, new ConstantPower(Power))
        {
        }
